...
echo -e "\033[1;32mInstall openssh,curl,neofetch,neovim,clang,python3. Needs network (doesn't contain pip)\033[0m"
...
echo -e "\033[1;33mDone. Reboot to apply all the changes"
echo -e "\033[1;33mInstalling zsh and ohmyzsh, recommend to run setzshxy after this.\033[0m"
